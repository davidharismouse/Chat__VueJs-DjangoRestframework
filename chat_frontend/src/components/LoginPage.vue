                        ...
                        <v-card class="px-4">
                            <v-card-text>
                                <v-form ref="loginForm" v-model="valid" lazy-validation>
                                    <v-row>
                                        <v-col cols="12">
                                            <v-text-field v-model="loginName" :rules="loginNameRules" label="UserName" required></v-text-field>
                                        </v-col>
                                        <v-col cols="12">
  ...
  export default {
    ...
    methods: {
      async validate() {
        ...
        const certification = await login(params);
        ...
        //   axios
        //     .post("http://127.0.0.1:8500/api/login/", {            
        //         username: this.loginName,
        //         password: this.loginPassword,            
        //     })
        //     .then((response) => {
